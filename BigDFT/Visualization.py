...
def truncate_colormap(cmap, compressed_values=None, vmin=0.0, vmax=1.0, N=-1):
...
def get_colordict(keys, field_vals=None, vmin=None, vmax=None,
                  colorcode='html'):
    """
...
def contrasting_text_color(hex_str):
    ...
    Args:
        hex_str (str): the color string in hex.
    Returns:
